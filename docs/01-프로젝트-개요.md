...
이 프로젝트는 [Python FastMCP 기반 원본](https://github.com/agoda-com/api-agent)을 **Spring Boot 3.4 + Java 21**로 포팅한 버전입니다. MCP 서버로서의 동작 방식은 동일하며, 구현체만 Spring AI 기반으로 변경되었습니다.
...
|------|------------|-----------------|
| 런타임 | Python 3.11 + FastMCP | Java 21 + Spring Boot 3.4 |
